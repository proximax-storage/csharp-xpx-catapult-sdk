# Contributing to nem2-sdk-csharp

First off, thank you for considering contributing to nem2-sdk-csharp. 
It’s people like you that make nem2-sdk-csharp such a great tool.

nem2-sdk-csharp is an open source project and we love to receive contributions from 
...
writing code which can be incorporated into nem2-sdk-csharp itself.
...
If you think you have found a bug in nem2-sdk-csharp, first make sure that you 
are testing against the latest version of nem2-sdk-csharp - your issue may already 
...
If you find yourself wishing for a feature that doesn't exist in nem2-sdk-csharp, 
you are probably not alone. There are bound to be others out there with similar 
needs. Many of the features that nem2-sdk-csharp has today have been added because 
our users saw the need. Open an [issue][github-issues] on our issues list on GitHub which describes 
the feature you would like to see, why you need it, and how it should work.

## Contributing code and documentation changes

If you have a bugfix or new feature that you would like to contribute to nem2-sdk-csharp, please find or open an issue 
...
You will need to fork the main nem2-sdk-csharp code or documentation repository and clone 
...
[github-issues]: https://github.com/nemtech/nem2-sdk-csharp/issues