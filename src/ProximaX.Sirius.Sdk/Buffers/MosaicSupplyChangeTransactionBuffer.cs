...
public struct MosaicSupplyChangeTransactionBuffer : IFlatbufferObject
{
  private Table __p;
...
#if ENABLE_SPAN_T
  public Span<byte> GetDeltaBytes() { return __p.__vector_as_span(22); }
#else
  public ArraySegment<byte>? GetDeltaBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public uint[] GetDeltaArray() { return __p.__vector_as_array<uint>(22); }
  ...
  public static VectorOffset CreateDeltaVectorBlock(FlatBufferBuilder builder, uint[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static void FinishSizePrefixedMosaicSupplyChangeTransactionBufferBuffer(FlatBufferBuilder builder, Offset<MosaicSupplyChangeTransactionBuffer> offset) { builder.FinishSizePrefixed(offset.Value); }
};
