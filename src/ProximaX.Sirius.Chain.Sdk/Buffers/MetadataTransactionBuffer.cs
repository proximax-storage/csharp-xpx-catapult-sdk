...
public struct MetadataTransactionBuffer : IFlatbufferObject
{
   private Table __p;
  ...
  public uint TargetId(int j) { int o = __p.__offset(22); return o != 0 ? __p.bb.GetUint(__p.__vector(o) + j * 4) : (uint)0; }
  public int TargetIdLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<uint> GetTargetIdBytes() { return __p.__vector_as_span<uint>(22, 4); }
#else
  public ArraySegment<byte>? GetTargetIdBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public uint[] GetTargetIdArray() { return __p.__vector_as_array<uint>(22); }
  public short ValueSizeDelta { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetShort(o + __p.bb_pos) : (short)0; } }
  public ushort ValueSize { get { int o = __p.__offset(26); return o != 0 ? __p.bb.GetUshort(o + __p.bb_pos) : (ushort)0; } }
  public byte Value(int j) { int o = __p.__offset(28); return o != 0 ? __p.bb.Get(__p.__vector(o) + j * 1) : (byte)0; }
  public int ValueLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<byte> GetValueBytes() { return __p.__vector_as_span<byte>(28, 1); }
#else
  public ArraySegment<byte>? GetValueBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public byte[] GetValueArray() { return __p.__vector_as_array<byte>(28); }
  ...
  public static void AddTargetId(FlatBufferBuilder builder, VectorOffset targetIdOffset) { builder.AddOffset(9, targetIdOffset.Value, 0); }
  public static VectorOffset CreateTargetIdVector(FlatBufferBuilder builder, uint[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddUint(data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTargetIdVectorBlock(FlatBufferBuilder builder, uint[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static void AddValueSize(FlatBufferBuilder builder, ushort valueSize) { builder.AddUshort(11, valueSize, 0); }
  public static void AddValue(FlatBufferBuilder builder, VectorOffset valueOffset) { builder.AddOffset(12, valueOffset.Value, 0); }
  ...
  public static Offset<MetadataTransactionBuffer> EndMetadataTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<MetadataTransactionBuffer>(o);
  }
  public static void FinishMetadataTransactionBufferBuffer(FlatBufferBuilder builder, Offset<MetadataTransactionBuffer> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedMetadataTransactionBufferBuffer(FlatBufferBuilder builder, Offset<MetadataTransactionBuffer> offset) { builder.FinishSizePrefixed(offset.Value); }
};
