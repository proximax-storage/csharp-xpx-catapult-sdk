...
{
    /// <summary>
    ///     Class MosaicLevyRemoveTransactionSchema
    /// </summary>
    internal class MosaicLevyRemoveTransactionSchema : SchemaHelpers.Schema
    {
        internal MosaicLevyRemoveTransactionSchema() : base(
