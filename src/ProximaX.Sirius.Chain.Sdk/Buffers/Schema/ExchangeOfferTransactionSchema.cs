...
{
    internal class ExchangeOfferTransactionSchema : SchemaHelpers.Schema
    {
        internal ExchangeOfferTransactionSchema() : base(
       new List<SchemaAttribute>
       {
                ...
                new TableArrayAttribute("offers", new List<SchemaAttribute>
                {
                    ...
                    new ArrayAttribute("cost", Constants.Value.SIZEOF_INT),
                    new ScalarAttribute("type", Constants.Value.SIZEOF_BYTE),
                    new ArrayAttribute("owner", Constants.Value.SIZEOF_BYTE)
                })
       })
        {
        }
