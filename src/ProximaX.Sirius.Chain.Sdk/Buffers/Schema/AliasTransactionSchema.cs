...
{
    internal class AliasTransactionSchema : SchemaHelpers.Schema
    {
        internal AliasTransactionSchema() : base(
            new List<SchemaAttribute>
            {
               ...
               new ScalarAttribute("version", Constants.Value.SIZEOF_INT),
                ...
                new ScalarAttribute("actionType", Constants.Value.SIZEOF_BYTE),
                new ArrayAttribute("namespaceId", Constants.Value.SIZEOF_INT),
                new ArrayAttribute("aliasId", Constants.Value.SIZEOF_BYTE)
            })
        {
        }
    }
