    ...
    internal class CatapultConfigTransactionSchema : SchemaHelpers.Schema
    {
        internal CatapultConfigTransactionSchema() : base(
            new List<SchemaAttribute>
            {
                ...
                new ArrayAttribute ("applyHeightDelta", Constants.Value.SIZEOF_INT),
                new ScalarAttribute("blockChainConfigSize", Constants.Value.SIZEOF_SHORT),
                new ScalarAttribute("supportedEntityVersionsSize", Constants.Value.SIZEOF_SHORT),
                new ArrayAttribute ("blockChainConfig", Constants.Value.SIZEOF_BYTE),
                new ArrayAttribute ("supportedEntityVersions", Constants.Value.SIZEOF_BYTE)
