...
namespace ProximaX.Sirius.Chain.Sdk.Buffers.Schema
{
    ...
    /// </summary>
    internal class MetadataTransactionSchema : SchemaHelpers.Schema
    {
        internal MetadataTransactionSchema() : base(
            new List<SchemaAttribute>
            {
                ...
                new ArrayAttribute("targetKey", Constants.Value.SIZEOF_BYTE),
                new ArrayAttribute("scopedMetadataKey", Constants.Value.SIZEOF_INT),
                new ArrayAttribute("targetId", Constants.Value.SIZEOF_INT),
                new ScalarAttribute("valueSizeDelta", Constants.Value.SIZEOF_SHORT),
                new ScalarAttribute("valueSize", Constants.Value.SIZEOF_SHORT),
