...
public struct RemoveExchangeOfferTransactionBuffer : IFlatbufferObject
{
  private Table __p;
  ...
  public static RemoveExchangeOfferTransactionBuffer GetRootAsRemoveExchangeOfferTransactionBuffer(ByteBuffer _bb, RemoveExchangeOfferTransactionBuffer obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public RemoveExchangeOfferBuffer? Offers(int j) { int o = __p.__offset(20); return o != 0 ? (RemoveExchangeOfferBuffer?)(new RemoveExchangeOfferBuffer()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int OffersLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<RemoveExchangeOfferTransactionBuffer> CreateRemoveExchangeOfferTransactionBuffer(FlatBufferBuilder builder,
      uint size = 0,
  ...
  public static VectorOffset CreateOffersVector(FlatBufferBuilder builder, Offset<RemoveExchangeOfferBuffer>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateOffersVectorBlock(FlatBufferBuilder builder, Offset<RemoveExchangeOfferBuffer>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartOffersVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<RemoveExchangeOfferTransactionBuffer> EndRemoveExchangeOfferTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<RemoveExchangeOfferTransactionBuffer>(o);
  }
  public static void FinishRemoveExchangeOfferTransactionBufferBuffer(FlatBufferBuilder builder, Offset<RemoveExchangeOfferTransactionBuffer> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedRemoveExchangeOfferTransactionBufferBuffer(FlatBufferBuilder builder, Offset<RemoveExchangeOfferTransactionBuffer> offset) { builder.FinishSizePrefixed(offset.Value); }
};
