...
public struct AliasTransactionBuffer : IFlatbufferObject
{
  private Table __p;
  ...
  public static AliasTransactionBuffer GetRootAsAliasTransactionBuffer(ByteBuffer _bb, AliasTransactionBuffer obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public byte ActionType { get { int o = __p.__offset(18); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  public uint NamespaceId(int j) { int o = __p.__offset(20); return o != 0 ? __p.bb.GetUint(__p.__vector(o) + j * 4) : (uint)0; }
  public int NamespaceIdLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<byte> GetNamespaceIdBytes() { return __p.__vector_as_span(20); }
#else
  public ArraySegment<byte>? GetNamespaceIdBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public uint[] GetNamespaceIdArray() { return __p.__vector_as_array<uint>(20); }
  /// In case of address it is 25 bytes array. In case of mosaic it is 8 byte array(or 2 uint32 array)
  public byte AliasId(int j) { int o = __p.__offset(22); return o != 0 ? __p.bb.Get(__p.__vector(o) + j * 1) : (byte)0; }
  public int AliasIdLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAliasIdBytes() { return __p.__vector_as_span(22); }
#else
  public ArraySegment<byte>? GetAliasIdBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public byte[] GetAliasIdArray() { return __p.__vector_as_array<byte>(22); }
  ...
  public static void AddActionType(FlatBufferBuilder builder, byte actionType) { builder.AddByte(7, actionType, 0); }
  public static void AddNamespaceId(FlatBufferBuilder builder, VectorOffset namespaceIdOffset) { builder.AddOffset(8, namespaceIdOffset.Value, 0); }
  ...
  public static void AddAliasId(FlatBufferBuilder builder, VectorOffset aliasIdOffset) { builder.AddOffset(9, aliasIdOffset.Value, 0); }
  public static VectorOffset CreateAliasIdVector(FlatBufferBuilder builder, byte[] data) { builder.StartVector(1, data.Length, 1); for (int i = data.Length - 1; i >= 0; i--) builder.AddByte(data[i]); return builder.EndVector(); }
  public static VectorOffset CreateAliasIdVectorBlock(FlatBufferBuilder builder, byte[] data) { builder.StartVector(1, data.Length, 1); builder.Add(data); return builder.EndVector(); }
  public static void StartAliasIdVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(1, numElems, 1); }
  public static Offset<AliasTransactionBuffer> EndAliasTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<AliasTransactionBuffer>(o);
  }
  public static void FinishAliasTransactionBufferBuffer(FlatBufferBuilder builder, Offset<AliasTransactionBuffer> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedAliasTransactionBufferBuffer(FlatBufferBuilder builder, Offset<AliasTransactionBuffer> offset) { builder.FinishSizePrefixed(offset.Value); }
};
