...
namespace ProximaX.Sirius.Chain.Sdk.Infrastructure.Mapping
{
    ...
    /// </summary>
    public class RemoveMosaicLevyTransactionMapping : TransactionMapping
    {
        /// <summary>
        ...
        /// <returns></returns>
        private static RemoveMosaicLevyTransaction ToMosaicRemoveLevyTransaction(JObject tx, TransactionInfo txInfo)
        {
            ...
            //var fee = transaction["fee"].ToObject<UInt64DTO>().ToUInt64();
            ...
            //var type = MosaicLevyTypeExtension.GetRawValue(transaction["type"].ToObject<int>());
            //var recipient = Recipient.From(Address.CreateFromHex(transaction["recipient"]?.ToObject<string>()));

            var removeMosaicLevyTransaction = new RemoveMosaicLevyTransaction(network, txVersion, deadline, mosaicId, maxFee, signature, signer, txInfo);
            return removeMosaicLevyTransaction;
        }
    }
}